...
for (int i=6;i<=10;i++){
  ...
  for (int i=6;i<=10;i++){
   ...
   System.out.println("Os números estão em ordem ordenada e crescente no começo, porém ficam em ordem decrescente no fim;");
   
   System.out.println("Pois como há uma pilha dentro de uma lista no fim do código, os nós ainda estarão de forma ordenada, porém invertidos, ou seja, de forma decrescente."); 
